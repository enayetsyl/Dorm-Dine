...
const Footer = () => {
  return (
    <div className="flex justify-center items-center shadow-2xl">
      <div className="bg-three w-1/2 py-12 flex flex-col justify-center items-center gap-10">
        <h1 className=" text-7xl text-black font-bold font-primary">DormDine</h1>
        <img src={logo} alt="" className='w-40 h-32' />
      </div>
      <div className="bg-five py-[100px] w-1/2 flex flex-col justify-center items-center gap-10">
