...
const Footer = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center shadow-2xl mt-36">
      ...
      <div className="bg-five py-[100px] md:w-1/2 flex flex-col justify-center items-center gap-10">
